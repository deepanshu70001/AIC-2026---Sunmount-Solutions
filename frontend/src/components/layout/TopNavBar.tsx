...
const TopNavBar = () => {
  ...
  return (
    <header className="fixed top-0 left-64 right-0 z-40 h-16 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-200/50 flex justify-between items-center px-8 shadow-sm">
